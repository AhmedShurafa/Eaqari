                        ...
                        <form action="{{ route('house.search') }}" method="get">
                            ...
                            <div class="form-row">
                                <div class="col-md-4 mb-3">
                                    <select name="areas_id" class="form-control">
                                        <option selected="true" disabled="disabled">المدينة</option>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select name="property_types_id" class="form-control" id="place">
                            ...
                            <div class="form-row">
                                <div class="col mb-3">
                                    ...
                                    <select name="room_number" id="rooms" class="form-control">
                                        <option selected="true" value="-1" disabled="disabled">عدد الغرف</option><!-- Bedrooms-->
                                ...
                                <div class="col mb-3">
                                    ...
                                    <input type="number" id="floor" name="floor" class="form-control" placeholder="الطابق">
                                </div>
                    ...
                    @foreach ($place as $value)
                            ...
                            <h2>
                                ...
                                @if ($value->owner->evaluate >= 4)
                                    <span class="text-warning float-left p-1 rounded"
                                        style="background-color: #FFF;border-color: #FFF" data-container="body"
                                        data-toggle="popover" data-placement="bottom" data-content="موثوق">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row py-2 text-secondary">
                                <div class="col-12">
                                    <i class="fas fa-th-large"></i> المساحة: {{ $value->size }}
                                </div>
                            </div>
                            @if ($value->property_types_id != 1)

                                <div class="row py-2 text-secondary">
                                    <div class="col-6">
                                        <i class="fas fa-bed"></i> عدد الغرف: {{ $value->room_number }}
                                    </div>
                                    <div class="col-6">
                                        <i class="fas fa-bath"></i> عدد الحمامات: {{ $value->bathrooms }}
                                    </div>
                                </div>
                            ...
                            <div class="row py-2 text-secondary">
                                <div class="col-12">
                                    <i class="fas fa-user"></i> {{ $value->owner->name }}
                                </div>
                            </div>
                    ...
                    @forelse($apartment as $value)
                        ...
                        <div class="card-body">
                            <div class="listing-heading text-center">
                                ...
                                <p>
                                    <i class="fas fa-map-marker text-secondary m-1"></i>{{ Str::limit($value->address, 15) }}
                                </p>
                            </div>
                            <hr>
                            <div class="row py-2 text-secondary">
